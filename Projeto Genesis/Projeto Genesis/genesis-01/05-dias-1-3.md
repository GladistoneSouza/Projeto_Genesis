...
**Arquitetura cósmica.** *(Esta seção descreve **como o capítulo está montado** — a arquitetura literária do texto. O que o leitor israelita imaginava fisicamente é outra pergunta, e está em [[09-antigo-oriente]] §5.9. Regra §14.)*

Até este ponto, tudo era água indiferenciada (v.2). Deus cria agora o espaço vertical — a expansão entre as **águas superiores** e as **águas inferiores**. Surge uma estrutura tripartida: águas acima → firmamento → águas abaixo. Essa arquitetura prepara o "palco" que será preenchido no quinto dia, quando aves povoarão o céu e peixes encherão os mares — confirmando o paralelismo entre os dias de formação (1–3) e os dias de preenchimento (4–6).

> **Correção declarada (2026-09-04).** Este parágrafo glosava as águas superiores como "(nuvens, chuva)" e o firmamento como "(céu/atmosfera)". As glosas foram **retiradas e não substituídas**: elas respondiam *o que existe de fato* (P2) apresentando-se como *o que o texto significa* (P1) — e o parágrafo sobre o dilúvio, adiante, já as desmentia ao voltar às "comportas dos céus". **O que o texto afirma sobre a natureza do *raqia* é questão em aberto**, registrada em [[../docs/posicoes|posicoes.md]]. A leitura literária acima não depende dela.
