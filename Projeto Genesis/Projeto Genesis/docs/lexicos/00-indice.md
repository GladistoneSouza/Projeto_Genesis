...
| **BDB** (1906) | **Livre**, domínio público; PDF local `sha256 75b1a66ee8ad2d1a33735ecf74790ea47232ce2e2eccdc4b130f12469f1ea3f3` | **F1** — *bohu* p. 96, *bara* p. 135, *rachaf* p. 934 e *tohu* p. 1062, páginas conferidas em 2026-09-24; outros lemas seguem no nível registrado em cada nota |
| **Klein**, etimológico | **Livre**, no Sefaria | **F2** — consultado nos três |
| **Strong’s** (índice/glosas) | PDF local AGES v1.0 (1999), `sha256 f143c669e516db05124f11525fe1ff715a9342919d92629a2628d154ab0d576a` | **F1** — glosas H922, H1254, H2896, H3117, H7363, H7549 e H8414 conferidas nas pp. 83, 114, 259, 280, 668, 684 e 763 do PDF; **F2** — contagens BLB/WLC, que não vêm desse PDF |
...
| **DCH** (Clines) | PDFs locais dos vols. I (1993; `sha256 f3483677238e5c7131f0b372a08f43d187dcfd6ab8a1723543e821a4956174a1`), II (`sha256 9837297374babef4033ecd25c541b625671640c47581a749da228d4db9e0f554`) e III; o arquivo `DCH Revised — Additions and Corrections` é suplemento distinto do vol. I; [Vol. II no Internet Archive](https://archive.org/details/dictionaryofclas0002unse) | **F1** — *Elohim* vol. I p. 277 e *adam* vol. I pp. 123–124, *bohu* vol. II p. 97, *bara* vol. II pp. 258–259, *tov* vol. III pp. 350–351; demais lemas pendentes |
...
| [[rachaf]] · רָחַף | Gn 1.2 | Corpus ✅ **exaustivo** — 3 ocorrências no AT · Klein/Jastrow **F2**; BDB p. 934, Strong H7363 e TWOT p. 843 **F1**; SDBH ❌ |
...
**Estado dos blocos:** corpus ✅ · BDB e Strong **F1** nos lemas indicados (glosas de Strong), Klein **F2** (leitura mediada) · UBS/SDBH **F1** (arquivo lido, commit e hash registrados) · DITAT ❌ não consultado · HALOT **F1** apenas para *bara* I/III · DCH I **F1** para *Elohim* e *adam*, II **F1** para *bohu* e *bara*, III **F1** para *tov* no aparato de Gn 1; demais entradas não consultadas e declaradas verbete a verbete.
